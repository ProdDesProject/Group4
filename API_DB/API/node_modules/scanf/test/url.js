...
describe('scanf', function() {
  describe('#Url', function() {
    ...
    it('[%s] \t\tshould match the url 2', function(done) {
      var str = sscanf(
        'http://search.aol.com/aol/search?enabled_terms=&s_it=comsearch&q=hello+world&s_chn=prt_main5',
        '%s'
      );
      should.strictEqual(
        str,
    ...
    it('[%s] \t\tshould match the url 3', function(done) {
      var str = sscanf(
        'https://www.google.com/search?q=hello+world&oq=hello+world&aqs=chrome..69i57j69i60l5.1379j0j4&sourceid=chrome&es_sm=93&ie=UTF-8',
        '%s'
      );
      should.strictEqual(
        str,
